\documentclass{article}
    ...
    \section{Business Needs/Problems}
        ...
        \subsection{Azure Hosting}
            ...
            \vspace{10mm}
            \begin{center}
                \includegraphics[width=270pt]{Images/OptimalSystemDiagram.jpg}
            \end{center}
            Such a design would allow for users to maintain connectivity from their 
            own LAN:
            \begin{center}
                \includegraphics[width=270pt]{Images/OptimalSystemDiagramAlternate.jpg}
            \end{center}
    ...
    \section{Project Objectives}
        ...
        The overall goals of the project is to enhance our knowledge of IOT sensor 
        ...
        \section{Deliverables}
            ...
            \subsection{Sensors}
            \begin{itemize}
                \item Sensors are created to read temperature.
                \item Sensors are created to read humidity.
                \item Sensors are created to read motion.
                \item Sensors can be reprogrammed with different modules (Or have all modules avilable).
                \item Sensor ownership can be modified.
