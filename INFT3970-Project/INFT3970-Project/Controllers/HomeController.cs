...
namespace INFT3970Project.Controllers
{
    public class HomeController : Controller
    {
        ...
        SqlConnection con = new SqlConnection("Server=tcp:inft3970.database.windows.net,1433;Initial Catalog=INFT3970;Persist Security Info=False;User ID=Dean;Password=INFT3970database;MultipleActiveResultSets=True;Encrypt=False;TrustServerCertificate=True;Connection Timeout=100;");
